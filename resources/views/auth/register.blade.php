                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="run" type="text" class="form-control{{ $errors->has('run') ? ' is-invalid' : '' }}" name="run" value="{{ old('run') }}" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="appat" type="text" class="form-control{{ $errors->has('appat') ? ' is-invalid' : '' }}" name="appat" value="{{ old('appat') }}" required autofocus>

                                @if ($errors->has('appat'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('appat') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="apmat" type="text" class="form-control{{ $errors->has('apmat') ? ' is-invalid' : '' }}" name="apmat" value="{{ old('apmat') }}" autofocus>

                                @if ($errors->has('apmat'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('apmat') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
