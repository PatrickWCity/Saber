          ...
          <form @submit.prevent="esEditar ? actualizarPerfil() : crearPerfil()" @keydown="form.onKeydown($event)">
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <input v-model="form.descripcion" type="text" name="descripcion" class="form-control" :class="{ 'is-invalid': form.errors.has('descripcion') }" placeholder="Descripción de Perfil">
